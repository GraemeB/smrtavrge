...
class ForecastsControllerTest < ActionController::TestCase
  ...
  test "should create forecast" do
    assert_difference('Forecast.count') do
      post :create, forecast: { forecast_explination: @forecast.forecast_explination, forecast_result: @forecast.forecast_result }
    end
  ...
  test "should update forecast" do
    put :update, id: @forecast, forecast: { forecast_explination: @forecast.forecast_explination, forecast_result: @forecast.forecast_result }
    assert_redirected_to forecast_path(assigns(:forecast))
  end
